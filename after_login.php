...
<section class="header">
   ...
   <a href="after_login.php" class="logo">travel.</a>
   ...
   <a href="home.php" class="" style="font-size: 2.5 rem;
   color:var(--black);
   ...
   <div class="swiper home-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide" style="background:url(images/home-slide-2.jpg) no-repeat">
            <div class="content">
               <h3>Start your journey with click</h3>
               <a href="package.php" class="btn">Book Your Adventure</a>
            </div>
         </div>
...
angle right is ">" instead of using images -->
      <div class="box">
         <h3>quick links</h3>
         <a href="after_login.php"> <i class="fas fa-angle-right"></i> home</a>
   ...
   <div class="credit"> created by <span>the A team</span> | all rights reserved! </div>
